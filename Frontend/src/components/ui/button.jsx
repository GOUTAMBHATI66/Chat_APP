...
const buttonVariants = cva(
  "yinline-flex yitems-center yjustify-center ywhitespace-nowrap yrounded-md ytext-sm yfont-medium yring-offset-white ytransition-colors focus-visible:youtline-none focus-visible:yring-2 focus-visible:yring-slate-950 focus-visible:yring-offset-2 disabled:ypointer-events-none disabled:yopacity-50 dark:yring-offset-slate-950 dark:focus-visible:yring-slate-300",
  {
    variants: {
      variant: {
        default:
          " ybg-slate-900 ytext-slate-50 hover:ybg-slate-900/90 dark:ybg-slate-50 dark:ytext-slate-900 dark:hover:ybg-slate-50/90",
        destructive:
          "ybg-red-500 ytext-slate-50 hover:ybg-red-700 dark:ybg-red-900 dark:ytext-slate-50 dark:hover:ybg-red-900/90",
        outline:
        ...
        ghost:
          " ytext-lg  ybg-slate-300 hover:ybg-slate-400 hover:ytext-slate-900 dark:hover:ybg-slate-800 dark:hover:ytext-slate-50",
