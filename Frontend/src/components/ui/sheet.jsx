...
const sheetVariants = cva(
  "yfixed yz-50 ygap-4 ybg-gray-200 yp-6 yshadow-lg ytransition yease-in-out data-[state=open]:yanimate-in data-[state=closed]:yanimate-out data-[state=closed]:yduration-300 data-[state=open]:yduration-500 dark:ybg-slate-950",
  {
    variants: {
      side: {
...
const SheetContent = React.forwardRef(
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="yabsolute yright-4 ytop-4 yrounded-sm yopacity-70 yring-offset-white ytransition-opacity hover:yopacity-100 focus:youtline-none focus:yring-2 focus:yring-slate-950 focus:yring-offset-2 disabled:ypointer-events-none data-[state=open]:ybg-slate-100 dark:yring-offset-slate-950 dark:focus:yring-slate-300 dark:data-[state=open]:ybg-slate-800">
...
const SheetTitle = React.forwardRef(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn(
      "ytext-lg yfont-semibold ytext-slate-950 dark:ytext-slate-50",
      className
    )}
    {...props}
  />
